<template>
  <div class="AVPT-outerbox">
    <div class="AVPT-innerbox">
...
export default {
  ...
  data() {
    return {
      url: [require("../../../../Pictures/square/aboutV/1.jpg")],
      srcList: [require("../../../../Pictures/square/aboutV/1.jpg")],
    };
  },
};
</script>
